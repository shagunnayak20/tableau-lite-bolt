  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Welcome to DataViz Dashboard.',
      });
    } catch (error) {
      toast({
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          >
            ...
            <h1 className="text-4xl font-display font-bold text-foreground mb-4">
              Start visualizing
              <span className="text-gradient block">in seconds</span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-md">
              Create your free account and transform raw data into actionable insights instantly.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            Join thousands of data analysts using DataViz
          </p>
